...
public class ModFoodComponents {
    ...
    public static final FoodComponent CHRISTMAS_COOKIE = new FoodComponent.Builder().alwaysEdible().hunger(4)
            ...
            .statusEffect(new StatusEffectInstance(StatusEffects.HEALTH_BOOST, 180),100f)
            .build();
    public static final FoodComponent SUGAR_COOKIE = new FoodComponent.Builder().alwaysEdible().hunger(4)
            .saturationModifier(0.25f)
            .statusEffect(new StatusEffectInstance(StatusEffects.INVISIBILITY,180),100f)
            .statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH,240),100f)
            .build();
}
